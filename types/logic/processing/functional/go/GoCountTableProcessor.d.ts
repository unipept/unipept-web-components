...
export default class GoCountTableProcessor extends FunctionalCountTableProcessor<GoCode, GoDefinition> {
     ...
     */
    constructor(peptideCountTable: CountTable<Peptide>, pept2Data: ShareableMap<Peptide, PeptideData>, goCommunicationSource: GoResponseCommunicator, percentage?: number);
