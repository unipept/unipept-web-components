...
import {FunctionalAnnotations, GroupedFA} from '../functional-annotations/FunctionalAnnotations.js';
// @ts-ignore
import worker from 'workerize-loader!./worker.js';
import GOTerms from '../functional-annotations/old-goterms.js';
import ECNumbers from '../functional-annotations/ecnumbers';
...
export default class Resultset {
    ...
    public async process() {
        const {processed, missed, numMatched, numSearched} = 
            await this.wrkr.process(this.dataset.originalPeptides, this.config);
     ...
     * @param sequences
     */
    public async processFA(cutoff: number = 50, sequences: Iterable<string> = null) {
     ...
     * @return GO term data
     */
    public async summarizeGo(percent: number = 50, sequences: Iterable<string> = null): Promise<GOTerms> {
     ...
     */
    public async summarizeEc(percent: number = 50, sequences: Iterable<String> = null): Promise<ECNumbers> {
