...
import { FunctionalCode, GoCode, HighlightedTreeProcessor, NcbiId, NcbiTree, Peptide } from '@/logic';
import { ref } from 'vue';
...
const expanded = ref<GoTableItem[]>([]);
...
const onExpandClicked = (item: GoTableItem) => {
